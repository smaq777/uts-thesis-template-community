...
% presentation. Print builds use the separately documented binding margins in
% config/print-settings.tex. Change any value only after checking every output.
\settrimmedsize{297mm}{210mm}{*}
\settypeblocksize{634pt}{*}{*}
\ifdefined\ThesisPrintMode
  \setulmarginsandblock{\PrintTopMargin}{\PrintBottomMargin}{*}
  \setlrmarginsandblock{\PrintInnerMargin}{\PrintOuterMargin}{*}
\else
  \setulmargins{40mm}{*}{*}
